...
class Transactions:
    ...
    async def approved_amount(
            self, token: types_mz.Contract, spender: types_mz.Contract, owner: types_mz.Address | None = None
    ) -> TokenAmount:
        """
    ...
    async def approve(
            self, token: types_mz.Contract, spender: types_mz.Address, amount: types_mz.Amount | None = None,
            gas_price: types_mz.GasPrice | None = None, gas_limit: types_mz.GasLimit | None = None,
