...
class Contracts:
    ...
    @staticmethod
    async def get_contract_attributes(contract: types_mz.Contract) -> tuple[ChecksumAddress, list | None]:
        """
    ...
    async def get(
            self, contract_address: types_mz.Contract, abi: list | str | None = None
